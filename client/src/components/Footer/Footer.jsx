...
const Footer = () => {
	return (
		<footer
			className="w-full h-full rounded-t-2xl bg-purple-500 text-gray-100 px-12 py-8  flex justify-start items-start space-x-12 md:px-24 md:py-12 xl:px-72">
			<ul>
				<li className="footerListTitle">Local Links</li>
				<li className="footerLink"><Link to="/">Home</Link></li>
				<li className="footerLink"><Link to="/portfolio">Portfolio</Link></li>
			</ul>
			<ul>
